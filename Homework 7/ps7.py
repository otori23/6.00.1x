...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        wordSet = self.wordTokens(text.lower())
        return (self.word in wordSet)
        
    def wordTokens(self, text):
        tranTable = string.maketrans(string.punctuation, " "*len(string.punctuation))
        newText = text.translate(tranTable)
...
def filterStories(stories, triggerlist):
    ...
    storySet = set(stories)
    return filter(triggerOnStory, storySet)            
